...
def main():
    ...
    LX_unilu = up.ScrData(tbl_name="raw_unilu").load_tbl_to_pd()
    LX_unilu.update_scraper_tbl().save_to_db()
    LX_unilu.create_or_update_tbl_labels()
    scr_data_objects.append(LX_unilu)

    DE_dkfz = up.ScrData(tbl_name="raw_dkfz").load_tbl_to_pd()
    ...
    scr_data_objects.append(DE_dkfz)

    DE_tum = up.ScrData(tbl_name="raw_tum").load_tbl_to_pd()
    ...
    scr_data_objects.append(DE_tum)


    CH_ethz=up.ScrData(tbl_name="raw_ethz").load_tbl_to_pd()
    ...
    scr_data_objects.append(CH_ethz)


    CH_unibas=up.ScrData(tbl_name="raw_unibas").load_tbl_to_pd()
    ...
    scr_data_objects.append(CH_unibas)

    CH_unibe = up.ScrData(tbl_name="raw_unibe").load_tbl_to_pd()
    ...
    scr_data_objects.append(CH_unibe)

    CH_unil = up.ScrData(tbl_name="raw_unil").load_tbl_to_pd()
    ...
    scr_data_objects.append(CH_unil)


    CH_uzh = up.ScrData(tbl_name="raw_uzh").load_tbl_to_pd()
    ...
    scr_data_objects.append(CH_uzh)

    NO_nmbu = up.ScrData(tbl_name="raw_nmbu").load_tbl_to_pd()
    ...
    scr_data_objects.append(NO_nmbu)

    NO_nord = up.ScrData(tbl_name="raw_nord").load_tbl_to_pd()
    ...
    scr_data_objects.append(NO_nord)

    NO_ntnu = up.ScrData(tbl_name="raw_ntnu").load_tbl_to_pd()
    ...
    scr_data_objects.append(NO_ntnu)

    NO_uib = up.ScrData(tbl_name="raw_uib").load_tbl_to_pd()
    ...
    scr_data_objects.append(NO_uib)

    NO_uio = up.ScrData(tbl_name="raw_uio").load_tbl_to_pd()
    ...
    scr_data_objects.append(NO_uio)
